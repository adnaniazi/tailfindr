...
guppy.single.flipflop.dna.231 <- '/export/valenfs/data/processed_data/MinION/20181219_max_dna_pcrspikes/renanalysis_with_guppy_flipflop/data_for_readtype_exploration/7-guppy-single-flipflop-dna-231.fast5'


extract_read_data(file_path = albacore.single.standard.rna,
...
extract_read_data(file_path = NA,
...
extract_read_data(file_path = guppy.single.flipflop.dna,
                  read_id_fast5_file = NA,
                  plot_debug = F,
...
extract_read_data(file_path = guppy.multi.flipflop.dna,
...
extract_read_data(file_path = guppy.single.standard.rna,
                  read_id_fast5_file = NA,
                  plot_debug = F,
                  basecalled_with = 'guppy',
                  multifast5 = F,
...
extract_read_data(file_path = guppy.multi.standard.rna,
...
extract_read_data(file_path = guppy.single.flipflop.dna.231,
                  read_id_fast5_file = NA,
                  plot_debug = F,
                  basecalled_with = 'guppy',
                  multifast5 = F,

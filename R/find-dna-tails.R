...
#'
#' @param multifast5 a logical [FALSE]. Set it to TRUE if the fast5 files in
#' fast5_dir are multifast5 files.
#'
#' @param basecalled_with_flipflop a logical [FALSE]. Set it to TRUE if the
...
find_dna_tails <- function(fast5_dir,
    ...
    # taking out this parameter from the function parameters list
    # as it may be dangerous for normal users
    show_plots=F

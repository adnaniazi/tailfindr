...
folder_path <- '/export/valenfs/data/processed_data/MinION/20180918_max_cdna_256_polya/demultiplexed_gfp_spikeins/poly_t_reads_100_percent_match_threshold/fished_out_reads/_10bp_reads/pass/0/'
...
a <- find_cdna_polyt_tail_per_read(file_path[13], save_plots=FALSE, show_plots=TRUE, save_dir='~')

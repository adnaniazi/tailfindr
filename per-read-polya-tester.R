...
file_path <- '/export/valenfs/data/processed_data/MinION/20181122_dna_pcr_spikeins/polya_estimation/gfp_aligned_reads/poly_a_reads/sars_HP_Z240_Tower_Workstation_20181122_FAK23880_MN21607_sequencing_run_all_82961_read_119091_ch_493_strand.fast5'
file_path <- paste('~/mnt/kjempetuja', file_path, sep='')

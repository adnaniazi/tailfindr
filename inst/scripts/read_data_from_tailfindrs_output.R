...
# 0.8 threshold
df <- read.csv("/Users/adnaniazi/mnt/kjempetuja/export/valenfs/data/processed_data/MinION/20190719_DNA_Max_RCA-GFP-2/tailfindr_rca_umi/tails_string_0.8_threshold.csv",
               stringsAsFactors = FALSE, header = TRUE)
...
write.table(df_fq,
            file="/Users/adnaniazi/mnt/kjempetuja/export/valenfs/data/processed_data/MinION/20190719_DNA_Max_RCA-GFP-2/tailfindr_rca_umi/read_length_vs_content_all_p8.txt",
            col.names = FALSE,
            row.names = FALSE
)
...
df_fq <- df_fq[df_fq$content_string != "",]
write.table(df_fq,
            file="/Users/adnaniazi/mnt/kjempetuja/export/valenfs/data/processed_data/MinION/20190719_DNA_Max_RCA-GFP-2/tailfindr_rca_umi/read_length_vs_content_only_complete_cases_p8.txt",
            col.names = FALSE,
            row.names = FALSE
)
...
# 0.8 threshold
df <- read.csv("/Users/adnaniazi/mnt/kjempetuja/export/valenfs/data/processed_data/MinION/20190506_DNA_Max_RCA-GFP/tailfindr_rca/tails_string_0.8_threshold.csv",
               stringsAsFactors = FALSE, header = TRUE)
...
write.table(df_fq,
            file="/Users/adnaniazi/mnt/kjempetuja/export/valenfs/data/processed_data/MinION/20190506_DNA_Max_RCA-GFP/tailfindr_rca/read_length_vs_content_all_p8_gfp_dataset1.txt",
            col.names = FALSE,
            row.names = FALSE
)
...
df_fq <- df_fq[df_fq$content_string != "",]
write.table(df_fq,
            file="/Users/adnaniazi/mnt/kjempetuja/export/valenfs/data/processed_data/MinION/20190506_DNA_Max_RCA-GFP/tailfindr_rca/read_length_vs_content_only_complete_cases_p8_gfp_dataset1.txt",
            col.names = FALSE,
            row.names = FALSE
)
